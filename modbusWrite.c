...
//***************** Pascal ************************
//user input = ./modbusWrite RegisterNumber RegisterValue ex. ./modbusWrite 8 255 put register 8 to 255
//Notes: register 8 to 15 = outputs 1 to 8
int main( int argc, char *argv[] )
{
	...
	if (writeHoldingRegister(1, out, value, 1000) < 0)
    {
